...
import DHLForm.DHLForm2;

/**
 *
 * @author smgKV878
 */
public class NewDHLForm extends javax.swing.JFrame {

    /**
     * Creates new form NewDHLForm
     */
    public NewDHLForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(544, 459));
        ...
        jLabel5.setText("     Welcome to DHL Delivery System");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/logo_.png"))); // NOI18N
...
private boolean isValidLogin(String username, String password) {
    String[][] validCredentials = new String[][]{
            {"user1", "123"},
            {"user2", "234"},
            {"Kliment", "123"}
    };
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(isValidLogin(jTextField1.getText(), jPasswordField1.getText())) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewDHLForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewDHLForm().setVisible(true);
            }
        });
    }
